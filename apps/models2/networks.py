...
def define_D(input_nc, ndf, which_model_netD,
             ...
             init_type='normal', init_gain=0.02, device='cpu'):
    netD = None
    ...
    if which_model_netD == 'basic':
        ...
        raise NotImplementedError('Discriminator model name [%s] is not recognized' %
                                  which_model_netD)
    return init_net(netD, init_type, init_gain, device)
...
def define_G(input_nc, output_nc, ngf,
    ...
    return init_net(netG, init_type, init_gain, device), cosis_list, cosis_list2, csa_model
