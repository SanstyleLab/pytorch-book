...
class TestModel(BaseModel):
    def __init__(self, name, checkpoints_dir, which_model_netG, which_epoch, ngf, batch_size,
        ...
        '''
        super().__init__(name, False, checkpoints_dir)
    ...
    def _initialize(self, which_model_netG, which_epoch, ngf, batch_size,
        ...
        self.input_A = torch.Tensor(batch_size, input_nc,
                                   fine_size, fine_size)
